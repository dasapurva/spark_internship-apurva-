    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item btn btn-secondary">
            <a class="nav-link link-text text-white" href="https://www.linkedin.com/in/apurva-das-308534212">linkedin</a>
          </li>
          <li class="nav-item btn btn-secondary">
            <a class="nav-link text-white" href="https://github.com/dasapurva">github</a>
          </li>
        </ul>
